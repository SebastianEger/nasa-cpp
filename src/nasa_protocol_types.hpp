...
namespace nasacpp
{
    ...
    struct Address
    {
        ...
        // serialization
        void decode(const std::vector<uint8_t> &data, unsigned int index);
    ...
    struct MessageSet
    {
        ...
        MessageNumber message_number = MessageNumber::UNDEFINED;
        ...
        MessageSet(MessageNumber message_number, long val = 0);

        // serialization
        static MessageSet decode(const std::vector<uint8_t> &data, unsigned int index, int capacity);
        void encode(std::vector<uint8_t> &data) const;
    };
    ...
    struct Packet
    {
        ...
        // create
        static Packet create(Address sa, Address da, DataType data_type, MessageNumber message_number, int value);
        static Packet createToBroadcastSelf(Address sa, DataType data_type, MessageNumber message_number, int value);
        static Packet createa_partial(Address sa, Address da, DataType data_type);
